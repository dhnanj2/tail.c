...
* Execute *train.py* file which is inside */Bot/* directory to train the model.
...
#### Rest api
This app allows you to interact with bot using a rest api. You can find the *controller.py* file inside */Tensorflow_Chatbot/Api/* location. To execute this Rest api you also need to install [Django framework](https://www.djangoproject.com/download/) 
...
You can find UI directory from root directory and then execute *UI/ChatView.py* file. Before executing this you need to install pygubu. Pygubu is a RAD tool which helps to develop python tknter base user interfaces.
...
```
* Then execute *ChatView.py* file inside */UI* directory.
...
* **Dhananjay Sharma** - MT23033 - M.Tech CSE - *IIIT, Delhi*
